...
const Home = () => {
  ...
  return (
    <div className=" bg-white dark:bg-zinc-900 transition-colors h-full w-full">
      <SEOHelmet page="home" />
      {/* Modern Hero Section with Carousel */}
      <section className="relative w-full h-full lg:min-h-[45em] min-h-[80em] overflow-hidden">
        <Carousel
          items={carouselItems}
          autoPlay={true}
